...
bank::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_DeleteAccount_(bank_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AddAmount_(bank_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubAmount_(bank_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListAccount_(bank_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status bank::Stub::DeleteAccount(::grpc::ClientContext* context, const ::bank::AccountDeleteReq& request, ::bank::AccountDeleteResp* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_DeleteAccount_, context, request, response);
}

void bank::Stub::experimental_async::DeleteAccount(::grpc::ClientContext* context, const ::bank::AccountDeleteReq* request, ::bank::AccountDeleteResp* response, std::function<void(::grpc::Status)> f) {
...
void bank::Stub::experimental_async::DeleteAccount(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::bank::AccountDeleteResp* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_DeleteAccount_, context, request, response, std::move(f));
}

void bank::Stub::experimental_async::DeleteAccount(::grpc::ClientContext* context, const ::bank::AccountDeleteReq* request, ::bank::AccountDeleteResp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void bank::Stub::experimental_async::DeleteAccount(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::bank::AccountDeleteResp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_DeleteAccount_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::bank::AccountDeleteResp>* bank::Stub::AsyncDeleteAccountRaw(::grpc::ClientContext* context, const ::bank::AccountDeleteReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::bank::AccountDeleteResp>::Create(channel_.get(), cq, rpcmethod_DeleteAccount_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::bank::AccountDeleteResp>* bank::Stub::PrepareAsyncDeleteAccountRaw(::grpc::ClientContext* context, const ::bank::AccountDeleteReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::bank::AccountDeleteResp>::Create(channel_.get(), cq, rpcmethod_DeleteAccount_, context, request, false);
}
...
bank::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      bank_method_names[2],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< bank::Service, ::bank::AccountDeleteReq, ::bank::AccountDeleteResp>(
          [](bank::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::bank::AccountDeleteReq* req,
             ::bank::AccountDeleteResp* resp) {
...
::grpc::Status bank::Service::DeleteAccount(::grpc::ServerContext* context, const ::bank::AccountDeleteReq* request, ::bank::AccountDeleteResp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
