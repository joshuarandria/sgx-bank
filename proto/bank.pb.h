...
extern AccountDeleteReqDefaultTypeInternal _AccountDeleteReq_default_instance_;
class AccountDeleteResp;
class AccountDeleteRespDefaultTypeInternal;
extern AccountDeleteRespDefaultTypeInternal _AccountDeleteResp_default_instance_;
class AmountAddReq;
...
template<> ::bank::AccountDeleteReq* Arena::CreateMaybeMessage<::bank::AccountDeleteReq>(Arena*);
template<> ::bank::AccountDeleteResp* Arena::CreateMaybeMessage<::bank::AccountDeleteResp>(Arena*);
...
class AccountDeleteReq PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bank.AccountDeleteReq) */ {
 public:
  inline AccountDeleteReq() : AccountDeleteReq(nullptr) {};
  virtual ~AccountDeleteReq();

  AccountDeleteReq(const AccountDeleteReq& from);
  AccountDeleteReq(AccountDeleteReq&& from) noexcept
    : AccountDeleteReq() {
    *this = ::std::move(from);
  }

  inline AccountDeleteReq& operator=(const AccountDeleteReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline AccountDeleteReq& operator=(AccountDeleteReq&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AccountDeleteReq& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AccountDeleteReq* internal_default_instance() {
    return reinterpret_cast<const AccountDeleteReq*>(
               &_AccountDeleteReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(AccountDeleteReq& a, AccountDeleteReq& b) {
    a.Swap(&b);
  }
  inline void Swap(AccountDeleteReq* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(AccountDeleteReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline AccountDeleteReq* New() const final {
    return CreateMaybeMessage<AccountDeleteReq>(nullptr);
  }

  AccountDeleteReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AccountDeleteReq>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AccountDeleteReq& from);
  void MergeFrom(const AccountDeleteReq& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AccountDeleteReq* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bank.AccountDeleteReq";
  }
  protected:
  explicit AccountDeleteReq(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:bank.AccountDeleteReq)
 private:
  class _Internal;
...
class AccountDeleteResp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bank.AccountDeleteResp) */ {
 public:
  inline AccountDeleteResp() : AccountDeleteResp(nullptr) {};
  virtual ~AccountDeleteResp();

  AccountDeleteResp(const AccountDeleteResp& from);
  AccountDeleteResp(AccountDeleteResp&& from) noexcept
    : AccountDeleteResp() {
    *this = ::std::move(from);
  }

  inline AccountDeleteResp& operator=(const AccountDeleteResp& from) {
    CopyFrom(from);
    return *this;
  }
  inline AccountDeleteResp& operator=(AccountDeleteResp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AccountDeleteResp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AccountDeleteResp* internal_default_instance() {
    return reinterpret_cast<const AccountDeleteResp*>(
               &_AccountDeleteResp_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(AccountDeleteResp& a, AccountDeleteResp& b) {
    a.Swap(&b);
  }
  inline void Swap(AccountDeleteResp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(AccountDeleteResp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline AccountDeleteResp* New() const final {
    return CreateMaybeMessage<AccountDeleteResp>(nullptr);
  }

  AccountDeleteResp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AccountDeleteResp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AccountDeleteResp& from);
  void MergeFrom(const AccountDeleteResp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AccountDeleteResp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bank.AccountDeleteResp";
  }
  protected:
  explicit AccountDeleteResp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:bank.AccountDeleteResp)
 private:
  class _Internal;
...
// string account_name = 1;
inline void AccountDeleteReq::clear_account_name() {
  account_name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& AccountDeleteReq::account_name() const {
  // @@protoc_insertion_point(field_get:bank.AccountDeleteReq.account_name)
  return _internal_account_name();
}
inline void AccountDeleteReq::set_account_name(const std::string& value) {
  _internal_set_account_name(value);
  // @@protoc_insertion_point(field_set:bank.AccountDeleteReq.account_name)
}
inline std::string* AccountDeleteReq::mutable_account_name() {
  // @@protoc_insertion_point(field_mutable:bank.AccountDeleteReq.account_name)
  return _internal_mutable_account_name();
}
inline const std::string& AccountDeleteReq::_internal_account_name() const {
  return account_name_.Get();
}
inline void AccountDeleteReq::_internal_set_account_name(const std::string& value) {
  
  account_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void AccountDeleteReq::set_account_name(std::string&& value) {
  
  account_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:bank.AccountDeleteReq.account_name)
}
inline void AccountDeleteReq::set_account_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  account_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:bank.AccountDeleteReq.account_name)
}
inline void AccountDeleteReq::set_account_name(const char* value,
    size_t size) {
  ...
  account_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:bank.AccountDeleteReq.account_name)
}
inline std::string* AccountDeleteReq::_internal_mutable_account_name() {
  
  return account_name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* AccountDeleteReq::release_account_name() {
  // @@protoc_insertion_point(field_release:bank.AccountDeleteReq.account_name)
  return account_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void AccountDeleteReq::set_allocated_account_name(std::string* account_name) {
  if (account_name != nullptr) {
  ...
  account_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), account_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:bank.AccountDeleteReq.account_name)
}
inline std::string* AccountDeleteReq::unsafe_arena_release_account_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:bank.AccountDeleteReq.account_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return account_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void AccountDeleteReq::unsafe_arena_set_allocated_account_name(
    std::string* account_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (account_name != nullptr) {
  ...
  account_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      account_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bank.AccountDeleteReq.account_name)
}
...
// int64 accountID = 1;
inline void AccountDeleteResp::clear_accountid() {
  accountid_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AccountDeleteResp::_internal_accountid() const {
  return accountid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AccountDeleteResp::accountid() const {
  // @@protoc_insertion_point(field_get:bank.AccountDeleteResp.accountID)
  return _internal_accountid();
}
inline void AccountDeleteResp::_internal_set_accountid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  accountid_ = value;
}
inline void AccountDeleteResp::set_accountid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_accountid(value);
  // @@protoc_insertion_point(field_set:bank.AccountDeleteResp.accountID)
}
